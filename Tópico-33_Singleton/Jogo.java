...
class JogoPainel extends JPanel implements Runnable {
	...
	public JogoPainel() {
		...
		Movel.instancia().setParametros(new Dimension(30, 30), 100, 300, 10, 0, Color.RED);
		Movel.instancia().setParametros(null, null, null, null, null, null);
	}
	...
	public void paintComponent(Graphics g) {
		...
		Movel.instancia().paintComponent(g);
	}
}
...
class Movel {
	...
	private Color cor;
    private static Movel instanciaUnica;

    private Movel(){
    }

    public static Movel instancia(){
        if(instanciaUnica == null){
            instanciaUnica = new Movel();
        }
